...
public class MovingViolationsManagerView 
{
	...
	public void printMenu() {
		...
		System.out.println("13. Mostrar los datos cargados en la lista cargada");
	...
	public void printMovingViolationsReq4(IStack<VOMovingViolations> resultados4) {
		...
		for(VOMovingViolations v: resultados4) {
			System.out.println( v.getObjectId() + "\t" + v.getTicketIssueDate() + "\t" + v.getStreetSegId() + "\t" + v.getAddressId());
		}
	}
	...
	public void printTotalData(Lista<VOMovingViolations> movingViolations) {
		
		for (int i = 0; i < movingViolations.size();i ++){
				System.out.println(movingViolations.getPos(i).getObjectId());
			}
	}
